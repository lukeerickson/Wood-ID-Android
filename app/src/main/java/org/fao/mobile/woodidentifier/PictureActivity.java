...
public class PictureActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Glide.with(PictureActivity.this).load(Uri.decode("/data/user/0/org.fao.mobile.woodidentifier/files/20230201110920reference/acacia_auriculiformis.jpg")).into(imageView);
